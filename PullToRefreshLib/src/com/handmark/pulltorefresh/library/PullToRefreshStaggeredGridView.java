...
public class PullToRefreshStaggeredGridView extends PullToRefreshAdapterViewBase<StaggeredGridView> {
	...
	protected StaggeredGridView createListView(Context context, AttributeSet attrs) {
		final StaggeredGridView lv;
	...
	protected StaggeredGridView createRefreshableView(Context context, AttributeSet attrs) {
		StaggeredGridView lv = createListView(context, attrs);
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if (lastVisiblePosition >= lastItemPosition - 1) {
				final int childIndex = lastVisiblePosition - mRefreshableView.getFirstVisiblePosition()*2;
