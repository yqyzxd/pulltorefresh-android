 ...
 * 描述:
 */
public class PullToRefreshRecyclerTwoView extends PullToRefreshBase<NestRecyclerView> {

    public PullToRefreshRecyclerTwoView(Context context) {
        super(context);
    }

    public PullToRefreshRecyclerTwoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshRecyclerTwoView(Context context, Mode mode) {
        super(context, mode);
    }

    public PullToRefreshRecyclerTwoView(Context context, Mode mode, AnimationStyle style) {
    ...
    @Override
    protected NestRecyclerView createRefreshableView(Context context, AttributeSet attrs) {
...
*/     NestRecyclerView scrollView = new NestRecyclerView(context, attrs);
    ...
    protected boolean isReadyForPullStart() {
        ...
        if (layoutManager instanceof StaggeredGridLayoutManager) {
            ...
            for (int i = 0; i < positions.length; i++) {
                 ...
                 */
                // 刚才忘了写判断是否是最后一个item了
                if (positions[i] <= (lm.getItemCount() - column)
    ...
    final class InternalRecyclerViewSDK9 extends RecyclerView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
            ...
            OverscrollHelper.overScrollBy(PullToRefreshRecyclerTwoView.this, deltaX, scrollX, deltaY, scrollY,
