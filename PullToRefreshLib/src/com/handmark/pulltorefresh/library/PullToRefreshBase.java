...
import com.handmark.pulltorefresh.library.internal.MuLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        //Log.e("OnIntercept","mIsBeingDragged:"+mIsBeingDragged);
    ...
    //edit by wind (protected to public)
    public final LoadingLayout getFootLayout() {
        return mFooterLayout;
    }
    ...
    private boolean mSizeChangedCalled;
    private boolean mUpdateRefreshableViewWhenSizeChanged = true;

    public void setUpdateRefreshableViewWhenSizeChanged(boolean updateRefreshableViewWhenSizeChanged) {
        this.mUpdateRefreshableViewWhenSizeChanged = updateRefreshableViewWhenSizeChanged;
    }
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mSizeChangedCalled && !mUpdateRefreshableViewWhenSizeChanged) {
            return;
        }
        mSizeChangedCalled = true;
        ...
        LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                ...
                case FLIP:
                    ...
                    return new MuLoadingLayout(context, mode, scrollDirection, attrs);
            }
        }
    }
